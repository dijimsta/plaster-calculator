...
- The bundle command targets Node.js 24 ESM with source maps, externalises third-party dependencies, bundles
  workspace dependencies, and rewrites the target `package.json`. Changes require Firebase deployment-focused
  verification.
