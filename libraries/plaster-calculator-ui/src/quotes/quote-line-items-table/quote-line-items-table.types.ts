 ...
 * every line has one: a flat-fee line (see `provenanceLabel` in
 * `quote-line-items-table.utils.ts`) carries `null` instead, and is either
 * explained by its `matchedKeywords` or identified as included by default.
 */
