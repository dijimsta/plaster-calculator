export const styles = Object.freeze({
    ...
    panel: "pointer-events-auto relative w-full overflow-hidden rounded-lg bg-white text-left shadow-xl transition duration-300 starting:translate-y-4 starting:opacity-0 sm:starting:translate-y-0 sm:starting:scale-95 dark:bg-slate-900",
    closeButton:
