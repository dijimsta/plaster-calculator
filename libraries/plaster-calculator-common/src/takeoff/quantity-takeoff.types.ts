 ...
 * `QuantityTakeoffCalculatorUtils.computeQuantities()`. This package has no
 * dependency on the generated Data Connect SDK — see
 ...
 * was computed for (by `id`). `QuantityTakeoffCalculatorUtils.
 * computeQuantities()` returns one of these per input
